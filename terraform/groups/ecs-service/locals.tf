...
locals {
  ...
  service_name              = "digital-certified-copy-processor"
  container_port            = "8080"
  docker_repo               = "digital-certified-copy-processor"
  kms_alias                 = "alias/${var.aws_profile}/environment-services-kms"
  healthcheck_path          = "/digital-certified-copy-processor/healthcheck" #healthcheck path for digital-certified-copy-processor
  healthcheck_matcher       = "200"
  vpc_name                  = local.stack_secrets["vpc_name"]
  s3_config_bucket          = data.vault_generic_secret.shared_s3.data["config_bucket_name"]
  app_environment_filename  = "digital-certified-copy-processor.env"
